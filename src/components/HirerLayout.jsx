...
export default function HirerLayout() {
  ...
  const links = [
    { name: 'Dashboard', path: '/hirer/dashboard', icon: 'dashboard' },
    { name: 'Company Profile', path: '/hirer/profile', icon: 'domain' },
    { name: 'Job Postings', path: '/hirer/jobs', icon: 'work' },
    { name: 'Candidates', path: '/hirer/candidates', icon: 'group' },
  ];
      ...
      <div className="flex flex-1 pt-16">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-surface-container-lowest border-r border-outline-variant h-[calc(100vh-64px)] sticky top-16 z-10">
          <div className="p-6 pb-2">
            <h2 className="font-title-sm font-bold text-on-surface-variant uppercase tracking-wider">Hirer Portal</h2>
          </div>
